...
import { APOYO_EVALUACION_OPTIONS } from '../types';
...
export const EvaluationSupportPicker: React.FC<Props> = ({ 
  rowId, 
  selectedOptions, 
  otherText, 
  onToggle, 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          >
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
              <div>
                <h3 className="font-bold text-lg">Apoyos en la Evaluación</h3>
                <p className="text-xs text-muted-foreground">Seleccione los apoyos curriculares para la evaluación</p>
              </div>
              <button 
                onClick={onClose}
            ...
            <div className="p-6 max-h-[60vh] overflow-y-auto space-y-2">
              {APOYO_EVALUACION_OPTIONS.map(option => {
              ...
              {selectedOptions.includes("Otros (especifique)") && (
                ...
                >
                  <textarea 
                    placeholder="Especifique otros apoyos de evaluación..."
                    value={otherText}
